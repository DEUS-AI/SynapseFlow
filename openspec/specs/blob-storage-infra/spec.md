# Spec: blob-storage-infra

## Purpose

Terraform infrastructure for Azure Blob Storage, providing document and markdown containers with private endpoint access and Key Vault secret integration for SynapseFlow's backend services.
