# Spec: postgres-document-tracking

## Purpose

Replace the JSON-file-based document tracker with Postgres-backed persistence via `DocumentRepository`, making the `documents` table the single source of truth for document lifecycle management.
