# Spec: document-storage-abstraction

## Purpose

A pluggable storage abstraction layer for document and markdown files, supporting both local filesystem (dev) and Azure Blob Storage (production) backends, selected via environment variable.
